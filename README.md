...
The Process: 
1.  The plugin will scan small frequency steps around your current position (10 kHz steps in FM, 1 kHz in AM)
2.  It calculates a "Score" for each step, weighing the signal strength against interference (CCI and ACI)
3.  Once the scan is complete, it automatically switches to the frequency with the highest score
